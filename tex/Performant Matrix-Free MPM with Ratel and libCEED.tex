...
\title[Matrix-Free MPM]{Performant Matix-Free MPM with Ratel and libCEED} % The short title appears at the bottom of every slide, the full title is only on the title page
...
\date{07 Nov 2025} % Date, can be changed to a custom date
