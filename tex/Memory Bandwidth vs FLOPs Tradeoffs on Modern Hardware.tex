...
\title[Memory vs FLOPs]{Memory Bandwidth vs FLOPs - Tradeoffs on Modern Hardware
...
\date{30 March 2026} % Date, can be changed to a custom date
...
\begin{center}
\includegraphics[height=4.75cm]{ElCapitan.png}
\end{center}
...
\begin{center}
\includegraphics[height=4.75cm]{ElCapitanRack.png}
\end{center}
...
\begin{center}
\includegraphics[height=4.75cm]{ElCapitanBlade.png}
\end{center}
...
\begin{center}
\includegraphics[height=4.75cm]{CPUDiagram.png}
\end{center}
...
\begin{center}
\includegraphics[height=1.75cm]{FiniteElements.png}
\end{center}

Basis of each element roughly of size $\left(n \,1D \, DoFs \right)^2$ ($\left(n \,1D \, DoFs \right)^3$ in 3D)\\
...
For 'tensor product' elements this drops to $\left(n \,1D \, DoFs \right)$ or $4$\\
